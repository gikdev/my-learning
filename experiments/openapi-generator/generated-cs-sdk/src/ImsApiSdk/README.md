...
additionalProperties:
  packageGuid: '{8A254A5A-CE71-4294-A2EC-5CD5C253496A}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IMenuGroupsApi>();
            ICreateMenuGroupApiResponse apiResponse = await api.CreateMenuGroupAsync("todo");
            MenuGroupItselfResponse? model = apiResponse.Ok();
        }
