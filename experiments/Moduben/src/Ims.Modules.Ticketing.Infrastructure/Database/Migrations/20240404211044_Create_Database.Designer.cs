...
namespace Ims.Modules.Ticketing.Infrastructure.Database.Migrations
{
    [DbContext(typeof(TicketingDbContext))]
    [Migration("20240404211044_Create_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ims.Common.Infrastructure.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Common.Infrastructure.Inbox.InboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("Ims.Common.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Common.Infrastructure.Outbox.OutboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.HasOne("Ims.Modules.Ticketing.Domain.Events.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.HasOne("Ims.Modules.Ticketing.Domain.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ims.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.HasOne("Ims.Modules.Ticketing.Domain.Orders.Order", null)
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("Ims.Modules.Ticketing.Domain.Events.TicketType", null)
                        .WithMany()
