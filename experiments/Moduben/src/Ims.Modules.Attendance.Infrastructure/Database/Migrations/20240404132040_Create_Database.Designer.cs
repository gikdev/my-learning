...
namespace Ims.Modules.Attendance.Infrastructure.Database.Migrations
{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ims.Modules.Attendance.Domain.Attendees.Attendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Attendance.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Attendance.Domain.Events.EventStatistics", b =>
                {
            ...
            modelBuilder.Entity("Ims.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ims.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("Ims.Modules.Attendance.Domain.Attendees.Attendee", null)
                        .WithMany()
                    ...
                    b.HasOne("Ims.Modules.Attendance.Domain.Events.Event", null)
                        .WithMany()
