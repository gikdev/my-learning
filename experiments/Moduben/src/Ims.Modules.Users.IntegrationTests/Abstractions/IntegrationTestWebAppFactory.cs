...
namespace Ims.Modules.Users.IntegrationTests.Abstractions;
...
#pragma warning restore CA1515
    ...
    private readonly KeycloakContainer _keycloakContainer = new KeycloakBuilder("quay.io/keycloak/keycloak:latest")
        .WithResourceMapping(
            new FileInfo("ims-realm-export.json"),
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder) {
        ...
        string keyCloakRealmUrl = $"{keycloakAddress}realms/ims";
        ...
        builder.ConfigureTestServices(services => {
            services.Configure<KeyCloakOptions>(o => {
                o.AdminUrl = $"{keycloakAddress}admin/realms/ims/";
