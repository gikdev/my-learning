...
namespace Bahrami85Api.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Bahrami85Api.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Bahrami85Api.Core.MultipartFormRequest
        {
