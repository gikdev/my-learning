...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::Bahrami85Api.Core.ApiResponse> MakeRequestAsync(
        global::Bahrami85Api.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::Bahrami85Api.Core.ApiResponse> SendRequestAsync(
        global::Bahrami85Api.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Bahrami85Api.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::Bahrami85Api.Core.ApiResponse
            {
    ...
    private static string BuildUrl(global::Bahrami85Api.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::Bahrami85Api.Core.ApiResponse instead.")]
    internal record ApiResponse : global::Bahrami85Api.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::Bahrami85Api.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::Bahrami85Api.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Bahrami85Api.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::Bahrami85Api.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Bahrami85Api.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::Bahrami85Api.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Bahrami85Api.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : global::Bahrami85Api.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Bahrami85Api.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::Bahrami85Api.Core.StreamRequest;
}
